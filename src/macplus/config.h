 ...
 * Copyright:   (C) 2002-2024 Hampa Hug <hampa@hampa.ch>                     *
 *****************************************************************************/
...
// #define PCE_BUILD_IBMPC 0

// #define PCE_ENABLE_X11 0
